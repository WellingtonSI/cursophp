<nav class="modulos">
    ...
    <div class="modulo amarelo-claro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=tratamento_erro&file=desafio/desafio_intdiv">
                    Desafio
                </a>
            </li>
            <li>
    ...
    <div class="modulo laranja-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=namespace&file=Comum/Tipo/desafio">
                    Desafio
                </a>
            </li>
        </ul>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=t">
                    Entre Arquivos
                </a>
            </li>
        </ul>
