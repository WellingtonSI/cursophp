...
<?php 
    if(count($_POST) > 0){
        ...
        if(!filter_var($_POST['salario'],FILTER_VALIDATE_FLOAT,$salarioConfig)){
            $erros['salario'] =  'Salário inválido, casas decimais com ","';
        }
    }
...
<form action="#" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="filhos">Qte de Filhos</label>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?= $erros['salario'] ? 'is-invalid':''?>s" id="salario" name="salario" placeholder="Salário" value="<?= $_POST['salario']?>">
            <div class="invalid-feedback">
                <?= $erros['salario'] ?>
            </div>
        </div>
