...
function calcaularTempoAposentadoria($idade){
    if($idade < 18){
...
$idadesAvaliadas = [15,35,60,80,85];

foreach($idadesAvaliadas as $idade){
    try {
        $tempoRestante = calcaularTempoAposentadoria($idade);
        echo "Idade: $idade, $tempoRestante anos restantes<br>";
    } catch(FaixaEtariaException $e){
        echo "Não foi possível calcular para de $idade anos.<br>";
